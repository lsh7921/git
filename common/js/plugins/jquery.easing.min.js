    ...
    e.fn.fullpage = function(l) {
        function s(n, t) {
            ...
            l.autoScrolling && !l.scrollBar ? (wt.css({
                ...
                "-ms-touch-action": "",
                "touch-action": ""
            }), ft(Lt), o.length && (console.log("llama scroll"), wt.scrollTop(o.position().top), console.log("fiunish scroll"))),
        ...
        function be() {
            ...
            l.scrollOverflow ? ("complete" === t.readyState && Me(), ne.on("load", Me)) : Re()
        }
        function xe(n, t, o) {
            var i = 100 * o,
            r = 100 / o;
        ...
        function Be() {
            ...
            if ((!l.autoScrolling || l.scrollBar || ut("dragAndMove")) && !vt()) {
                ...
                if (c) r = d.length - 1;
                else if (i) for (var f = 0; f < d.length; ++f) {
                    var u = d[f];
                    u.offsetTop <= a && (r = f)
                } else r = 0;
                if (n = e(d).eq(r), !n.hasClass(p)) {
                    ...
                    Ht && (n.addClass(p).siblings().removeClass(p), ht("parallax", "afterLoad"), e.isFunction(l.onLeave) && l.onLeave.call(g, m, x, S), e.isFunction(l.afterLoad) && l.afterLoad.call(n, w, x), l.resetSliders && bt.resetSliders && bt.resetSliders.apply({
                        localIsResizing: Ot,
                        leavingSection: m
                    }), on(g), en(n), nn(n), zn(w, x - 1), l.anchors.length && (xt = w), Gn(h, v, w, x)),
                    clearTimeout(Ft),
        ...
        function Fe(e) {
            var n = e.originalEvent; ! We(e.target) && l.autoScrolling && je(n) && e.preventDefault()
        }
        function Ve(n) {
        ...
        function Qe(n) {
            if (l.css3 && l.autoScrolling && !l.scrollBar) {
                ...
                Wn(t, !0),
                l.scrollingSpeed ? (clearTimeout(Dt), Dt = setTimeout(function() {
                    $e(n)
                },
        ...
        function an(e) {
            function n(e) {
                var n, o, i, r, l, s, c, d = "",
                f = 0;
                for (e = e.replace(/[^A-Za-z0-9+\/=]/g, ""); f < e.length;) r = a.indexOf(e.charAt(f++)),
            ...
            function t(e) {
                for (var n, t = "", o = 0, i = 0, r = 0; o < e.length;) i = e.charCodeAt(o),
                i < 128 ? (t += String.fromCharCode(i), o++) : i > 191 && i < 224 ? (r = e.charCodeAt(o + 1), t += String.fromCharCode((31 & i) << 6 | 63 & r), o += 2) : (r = e.charCodeAt(o + 1), n = e.charCodeAt(o + 2), t += String.fromCharCode((15 & i) << 12 | (63 & r) << 6 | 63 & n), o += 3);
                return t
            }
            function o(e) {
                return e
        ...
        function Cn(n, t, o) {
            ...
            l.onSlideLeave && !r.localIsResizing && "none" !== r.xMovement && e.isFunction(l.onSlideLeave) && l.onSlideLeave.call(r.prevSlide, r.anchorLink, r.sectionIndex + 1, r.prevSlideIndex, r.xMovement, r.slideIndex) === !1 ? void(Tt = !1) : (t.addClass(p).siblings().removeClass(p), r.localIsResizing || (on(r.prevSlide), en(t)), An(r), i.hasClass(p) && Gn(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex), bt.continuousHorizontal && bt.continuousHorizontal.apply(r), vt() ? Tn(r) : In(n, r, !0), void(l.interlockedSlides && bt.interlockedSlides && bt.interlockedSlides.apply(r)))
        }
        function An(e) { ! l.loopHorizontal && l.controlArrows && (e.section.find(_).toggle(0 !== e.slideIndex), e.section.find(ee).toggle(!e.destiny.is(":last-child")))
        }
        function Tn(n) {
            bt.continuousHorizontal && bt.continuousHorizontal.afterSlideLoads(n),
            kn(n.slidesNav, n.slideIndex),
            n.localIsResizing || (ht("parallax", "afterSlideLoads"), e.isFunction(l.afterSlideLoad) && l.afterSlideLoad.call(n.destiny, n.anchorLink, n.sectionIndex + 1, n.slideAnchor, n.slideIndex), Ht = !0, nn(n.destiny)),
            Tt = !1,
        ...
        function Pn(e) {
            if (!e.hasClass("fp-noscroll")) {
                ...
                var a = Vn(i);
                n > a ? r.length ? t.update(e, a) : (l.verticalCentered ? e.find(T).wrapInner(o) : e.wrapInner(o), t.create(e, a, l.scrollOverflowOptions)) : t.remove(e),
                e.css("overflow", "")
            }
        }
        function Fn(e) {
        ...
        function Yn(e, n) {
            var t = jn(e);
            t.length && ("undefined" == typeof n && (n = 0), e === xt || t.hasClass(p) ? Nn(t, n) : Xe(t,
            function() {
                Nn(t, n)
            }))
        }
        ...
        function Gn(e, n, t, o) {
            var i = "";
            l.anchors.length && !l.lockAnchors && (e ? ("undefined" != typeof t && (i = t), "undefined" == typeof n && (n = e), Ct = n, Un(i + "/" + n)) : "undefined" != typeof e ? (Ct = n, Un(t)) : Un(t)),
            Qn()
        }
        function Un(e) {
            if (l.recordHistory) location.hash = e;
            else if (It || kt) n.history.replaceState(i, i, "#" + e);
            else {
        ...
        function nt() { (It || kt) && (l.autoScrolling && yt.off(Zt.touchmove).on(Zt.touchmove, Fe), e(a).off(Zt.touchstart).on(Zt.touchstart, Ze).off(Zt.touchmove).on(Zt.touchmove, Ve))
        }
        function tt() { (It || kt) && e(a).off(Zt.touchstart).off(Zt.touchmove)
        }
        function ot() {
            var e;
        ...
        function it(e) {
            ...
            kt && je(e) && l.scrollBar && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX),
            n
        }
        function rt(e, n) {
            X(0, "internal"),
        ...
        function dt() {
            ...
            yt.removeClass(c),
            e.each(yt.get(0).className.split(/\s+/),
            function(e, n) {
        ...
        kt = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints,
        Lt = e(this),
        Mt = ne.height(),
        Ot = !1,
        Et = !0,
